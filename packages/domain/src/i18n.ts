...
const el: Translations = {
  ...
  "Move down": "Κάτω",
  "Save": "Αποθήκευση",
  "Mark as paid": "Σήμανση ως πληρωμένο",
  "Unmark": "Αποσήμανση",
  "Could not mark payment": "Δεν ήταν δυνατή η σήμανση πληρωμής",
  "Could not unmark payment": "Δεν ήταν δυνατή η αποσήμανση πληρωμής",
  "Install app": "Εγκατάσταση εφαρμογής",
  "Add Fair Share to your home screen for quick access.": "Πρόσθεσε το Fair Share στην αρχική οθόνη για γρήγορη πρόσβαση.",
  "Install": "Εγκατάσταση",
  "Try again": "Προσπάθησε ξανά",
  "Date": "Ημερομηνία",
  "Category": "Κατηγορία",
  "Select category": "Επίλεξε κατηγορία",
  "Note": "Σημείωση",
  ...
  "Amount": "Ποσό",
  "Currency": "Νόμισμα",
  "Rate to {{currency}}": "Ισοτιμία προς {{currency}}",
  "1 unit of this currency equals how much in {{currency}}?": "1 μονάδα αυτού του νομίσματος ισούται με πόσα {{currency}};",
  "Tax": "Φόρος",
  "Tip": "Φιλοδώρημα",
  "tax": "φόρος",
  "tip": "φιλοδώρημα",
  "≈ {{amount}}": "≈ {{amount}}",
  "Tax and tip are added to the amount before splitting.": "Ο φόρος και το φιλοδώρημα προστίθενται στο ποσό πριν τη διαίρεση.",
  "Search expenses": "Αναζήτηση εξόδων",
  "Backup": "Αντίγραφο ασφαλείας",
  "Download all trips on this device as one backup file, or restore a backup.": "Κατέβασε όλα τα ταξίδια αυτής της συσκευής ως ένα αρχείο αντιγράφου ή επανάφερε ένα αντίγραφο.",
  "Export backup": "Εξαγωγή αντιγράφου",
  "Restore backup": "Επαναφορά αντιγράφου",
  "No trips on this device to back up": "Δεν υπάρχουν ταξίδια σε αυτή τη συσκευή για αντίγραφο",
  "Backup downloaded": "Το αντίγραφο κατέβηκε",
  "Backup restored": "Το αντίγραφο επανήλθε",
  "Could not export backup": "Δεν ήταν δυνατή η εξαγωγή αντιγράφου",
  ...
  "Road trip": "Οδικό ταξίδι",
  "Holiday": "Διακοπές",
  "Print summary": "Εκτύπωση σύνοψης",
  "Share summary": "Κοινοποίηση σύνοψης",
  "Summary copied": "Η σύνοψη αντιγράφηκε",
  "Print or save a summary of this trip": "Εκτύπωσε ή αποθήκευσε σύνοψη αυτού του ταξιδιού",
  "Share a text summary of this trip": "Κοινοποίησε κειμενική σύνοψη αυτού του ταξιδιού",
  "Fair Share trip summary": "Σύνοψη ταξιδιού Fair Share",
  "Total": "Σύνολο",
  ...
  "Unarchive": "Επαναφορά",
  "Archive this trip": "Αρχειοθέτηση ταξιδιού",
  "Unarchive this trip": "Επαναφορά ταξιδιού",
  "Delete this trip forever": "Διαγραφή ταξιδιού για πάντα",
  "Delete this trip forever? This cannot be undone.": "Διαγραφή ταξιδιού για πάντα; Αυτό δεν αναιρείται.",
  "Could not archive trip": "Δεν ήταν δυνατή η αρχειοθέτηση ταξιδιού",
  "Paid {{paid}} · {{remaining}} left": "Πληρωμένα {{paid}} · απομένουν {{remaining}}",
  "Pay partial": "Μερική πληρωμή",
  "How much has {{from}} paid {{to}} so far?": "Πόσα έχει πληρώσει ο/η {{from}} στον/στην {{to}} μέχρι τώρα;",
  "already paid": "ήδη πληρωμένα",
  "Cannot pay more than what is owed": "Δεν μπορείς να πληρώσεις περισσότερα από όσα οφείλονται",
  "Could not record payment": "Δεν ήταν δυνατή η καταγραφή πληρωμής",
  "Partial payment": "Μερική πληρωμή",
  "How much has {{from}} paid {{to}}?": "Πόσα έχει πληρώσει ο/η {{from}} στον/στην {{to}};",
  "On Android, mark the full payment as paid or adjust it on the web.": "Στο Android, σημείωσε την πλήρη πληρωμή ή προσάρμοσέ την στο web.",
  ...
  "Discard": "Απόρριψη",
  "Discard this pending photo?": "Απόρριψη αυτής της εκκρεμούς φωτογραφίας;",
  "Photo waiting to upload": "Φωτογραφία που αναμένει μεταφόρτωση",
  "Discard pending photo": "Απόρριψη εκκρεμούς φωτογραφίας",
